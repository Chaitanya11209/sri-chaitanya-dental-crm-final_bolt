...
export default function Collections() {
  ...
  useEffect(() => {
    ...
    if (!hasAccess) { setLocation('/crm/dashboard'); return; }
  ...
  useEffect(() => { if (hasAccess) fetchData(); }, [dateRange, hasAccess]);
      ...
      <div className="flex flex-col items-center justify-center h-[60vh] gap-4 text-center">
        ...
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1 max-w-sm">
            Collections and revenue data are only accessible to Admin and Doctor users. Contact your administrator for access.
          </p>
        </div>
        <button
