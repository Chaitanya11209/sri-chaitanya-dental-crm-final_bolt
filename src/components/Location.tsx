    ...
    <section id="contact" className={`py-12 sm:py-16 lg:py-28 ${darkMode ? 'bg-slate-800/50' : 'bg-white'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-4 sm:gap-8">
          <div className={`p-4 sm:p-8 rounded-xl smrounded-2xl ${darkMode ? 'bg-slate-800' : 'bg-slate-50'}`}>
            <div className="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-6">
              ...
              <div>
                ...
                <p className={`text-xs sm:text-sm leading-relaxed mb-3 ${darkMode ? 'text-slate-400' : 'text-slate-600'}`}>
                ...
                <a
                  id="clinic-get-directions-address-button"
                  href="https://www.google.com/maps/dir/?api=1&destination=Sri+Chaitanya+Multispeciality+Dental+Care+Ameenpur+Telangana+502032"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-teal-600 hover:bg-teal-750 text-white font-bold text-xs uppercase tracking-wider transition-all duration-150 cursor-pointer shadow-sm hover:shadow active:scale-97 select-none mt-2"
                >
                  <Compass size={14} className="text-teal-100" />
          ...
          <div className="relative lg:col-span-2 rounded-xl sm:rounded-2xl overflow-hidden shadow-lg sm:shadow-xl min-h-[300px] sm:min-h-[400px] lg:h-[500px]">
            <iframe
            ...
            />
            {/* Direct Floating Overlay Navigation Action */}
            <div id="floating-map-navigation-overlay" className="absolute bottom-4 left-4 right-4 sm:left-auto sm:right-4 z-10 flex flex-col gap-2 max-w-sm">
              <a
                id="floating-map-gps-direction-button"
                href="https://www.google.com/maps/dir/?api=1&destination=Sri+Chaitanya+Multispeciality+Dental+Care+Ameenpur+Telangana+502032"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 px-5 py-3 h-11 rounded-xl bg-slate-900/90 hover:bg-slate-900 border border-slate-705/50 backdrop-blur-md text-teal-400 font-extrabold text-xs uppercase tracking-wider transition-all duration-150 cursor-pointer shadow-xl select-none text-center"
              >
                <Compass size={15} className="animate-pulse" />
                Open GPS Navigator (Ameenpur)
              </a>
            </div>
          </div>
        </div>
