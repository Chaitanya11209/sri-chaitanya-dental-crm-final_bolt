...
5. **Access Application**:
   ...
   - Local mock-auth mode (works out-of-the-box when environment variables are blank) provides default credentials:
     - **Admin Role**: `admin@gmail.com` / `admin123`
     - **Staff Role**: `staff@gmail.com` / `staff123`
